...
public abstract class ContainerBuildingWrapper extends Building implements
		Container {

	public ContainerBuildingWrapper(float x, float y, int player) {
		super(x, y, player);
	}

	public ContainerBuildingWrapper(HashMap<String, Object> Properties,
