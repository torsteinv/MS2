...
public class Refiner extends Machine {

	public Refiner(int CanvasX, int CanvasY, Building Home, int Player) {
		super(CanvasX, CanvasY, Home, Player);
		this.Properties.put("Texture",
				MainResourceLoading.images.get("Refiner"));
	}

	public Refiner(HashMap<String, Object> Properties,
